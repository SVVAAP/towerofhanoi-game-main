...
GAME_FONT = "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/fonto.ttf"
GAME_FONT2 = "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/DK Jambo.otf"

# Musik yang dipakai dalam game
BG_MUSIC = 'E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/music.ogg'

GAME_CAPTION = 'Tower of Hanoi!'
BACK_BUTTON = "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/back.png"
...
gameIcon = pg.image.load('E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/logo.png')
...
def pgSlider(pos, var=True):
    ...
    if var:
        ...
        pgImage(pos, size, "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/tog-on.png", action=None)
    else:
        pgImage(pos, size, "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/tog-off.png", action=None)
...
def GameHomePage():
    ...
    while True:
        ...
        pgImage((GAME_WIDTH/2-100, GAME_HEIGHT/2-100), (200, 200), "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/play-h.png", GameHistory)
        pgImage((GAME_WIDTH/6-40, 450), (80, 80), "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/about.png", GameAbout)
        pgImage((GAME_WIDTH/6*2-40, 450), (80, 80), "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/secret.png", GameSecret1)
        pgImage((GAME_WIDTH/6*3-40, 450), (80, 80), "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/hof.png", GameHOF)
        pgImage((GAME_WIDTH/6*4-40, 450), (80, 80), "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/setting.png", GameSetting)
        pgImage((GAME_WIDTH/6*5-40, 450), (80, 80), "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/exit.png", GameQuit)
...
def GameLogin():
    ...
    while not done:
        ...
        pgImage((GAME_WIDTH/2-100, GAME_HEIGHT/2-250), (200, 200), "E:/COLLEGE PROJECTS/towerOfHanoi/towerofhanoi-game-main/towerofhanoi-game-main/assets/play-h.png")
